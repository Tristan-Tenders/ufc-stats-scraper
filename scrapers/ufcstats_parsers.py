"""Vendored from https://github.com/Greco1899/scrape_ufc_stats (GPL-3.0).

Battle-tested BeautifulSoup parsers for ufcstats.com pages. These produce the
exact CSV schemas consumed by build_dataset.py. Do not edit parsing logic here;
fetch_fights.py overrides get_soup() to add throttling, retries, and
user-agent rotation.
"""
